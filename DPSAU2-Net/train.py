...
from loss import *
from model.DPSAU2Net import DPSAU2NET
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='D:/data', help='the path of image')
    parser.add_argument('--csvfile', type=str, default='src/',
