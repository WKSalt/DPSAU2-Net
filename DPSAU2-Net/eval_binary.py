...
if __name__ == '__main__':
    ...
    parser.add_argument('--csvfile', default='src/', type=str,
                        help='two columns [image_id,category(train/test)]')
    parser.add_argument('--model', default='save_models/', type=str, help='the path of model')
    ...
    print('mean acccuracy:', round(np.mean(acc_score), 4), round(np.std(acc_score), 4))
